    ...
    <div class="bfv-body" id="bfv-pbody">
      <div class="bfv-step active" id="bfv-ps1">
        ...
        <div class="bfv-field-row">
          ...
          <div class="bfv-field" id="bfv-pf-sec"><label>Sector *</label><select id="bfv-p-sec"><option value="">Select sector</option><option>CPG / Consumer</option><option>Sports</option><option>B2B SaaS</option><option>Fintech</option><option>Health &amp; Bio</option><option>Deep Tech</option><option>Climate</option><option>Marketplace</option><option>Other</option></select><span class="bfv-field-error">Required</span></div>
        </div>
