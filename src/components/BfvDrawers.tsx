    ...
    <div class="bfv-body" id="bfv-pbody">
      <div class="bfv-step active" id="bfv-ps1">
        ...
        <div class="bfv-field-row">
          <div class="bfv-field" id="bfv-pf-st"><label>Stage *</label><select id="bfv-p-st"><option value="">Select stage</option><option>Pre-Seed</option><option>Seed</option><option>Series A</option><option>Other</option></select><span class="bfv-field-error">Required</span></div>
